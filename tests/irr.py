...
class IRRTests(unittest.TestCase):
    ...
    def test_compute_scores(self):
        ...
        self.assertAlmostEquals(scores['coder1_std'], .24, 2)
        self.assertAlmostEquals(scores['coder2_std'], .24, 2)
        ...
        self.assertAlmostEquals(scores['coder2_mean'], .4, 2)
        self.assertAlmostEquals(scores['coder1_mean'], .6, 2)
